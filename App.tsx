    ...
    <ErrorBoundary>
      <div className="h-screen w-screen relative overflow-hidden bg-gray-900 font-sans antialiased">
        ...
        {isMapsApiLoaded ? (
          ...
          // Show loading spinner ONLY if there isn't an error preventing the API from loading
          !serverError && <LoadingSpinner message={t('loading_map_services', language)} />
        )}

        {/* Fullscreen Loading Spinner for in-app actions */}
        {showLoadingSpinner && (
          <LoadingSpinner 
